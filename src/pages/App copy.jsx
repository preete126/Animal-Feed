...
function App() {
  const animalInfo = useRef(
    [
      {
        name: "Cow", image: Rectangle1, purpose: ["Work", "Dairy", "Food"], onClick: () => handleAnimalClick("catte"),
      },
      {
        name: "Sheep", image: Rectangle13, purpose: ["Dairy", "Food"], onClick: () => handleAnimalClick("cattle"),
      },
      {
        name: "Rabbit", image: Rectangle20, purpose: ["Dairy", "Food"], onClick: () => handleAnimalClick("rabbit"),
      },
      {
        name: "Goat", image: Rectangle11, purpose: ["Dairy", "Food"],onClick: () => handleAnimalClick("goat"),
      },
      {
        name: "Fish", image: Rectangle12, purpose: ["Dairy", "Food"],onClick: () => handleAnimalClick("fish"),
      },
      {
        name: "Poultry", image: Rectangle10, purpose: ["Dairy", "Food"],onClick: () => handleAnimalClick("Poultry"),
      },
      {
        name: "Horse", image: Rectangle21, purpose: ["Work", "Dairy", "Food"],onClick: () => handleAnimalClick("horse"),
      },
      {
        name: "Horse", image: Rectangle21, purpose: ["Work", "Dairy", "Food"],onClick: () => handleAnimalClick("Horse"),
      },
              ...
              {animalInfo.current.map((item, index) => (
                <div key={index}>
                  <div className='animalPhase'>
                    <img src={item.image} alt="" onClick={item.onClick} />
